...
LEGACY_AUTHOR_MAP = {
    ...
    "wyuebei@gmail.com": "wyuebei-cloud",  # PR #56640 salvage (haos journey: replace GNU-only %-d strftime with dt.day for Windows)
    ...
    "sberan@gmail.com": "sberan",  # PR #54494 salvage (--connect-timeout flag on haos mcp add)
