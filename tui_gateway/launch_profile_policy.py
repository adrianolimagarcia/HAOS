"""Launch-profile policy for a process that hosts several profile homes (``haos serve`` /
``haos dashboard`` pooling, ``?profile=``, hosted rooms; the multiplexed gateway's own worker).
