...
DEFAULT_CONFIG = {
    ...
    "gateway": {  # Gateway settings (messaging platforms: Telegram, Discord, Slack, ...).
        ...
        # May `haos update` fold this install onto a multiplexed default gateway by itself?
        ...
        # `haos gateway migrate --multiplex` is an explicit request and always proceeds.
        "auto_migrate": True,
