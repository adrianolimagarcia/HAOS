...
The provider list shown by ``haos model`` (CLI/TUI) and the desktop Settings → Providers tabs
...
def provider_catalog() -> list[ProviderDescriptor]:
    """One descriptor per provider in the ``haos model`` universe (:data:`CANONICAL_PROVIDERS`,
