...
KANBAN_GUIDANCE = (
    ...
    "sits in `ready` forever). Ground every assignee in a real profile (`" + product_command("profile") + " list`, or ask the user), and " +
    "express dependencies via `parents=[...]` on `kanban_create`, not prose.\n" +
    "\n" +
    "## Do NOT\n\n" +
    "- Do not shell out to `" + product_command("kanban") + " <verb>` for board operations. Use the `kanban_*` tools — they work across " +
