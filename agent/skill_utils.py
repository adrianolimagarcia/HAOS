...
PROJECT_SKILLS_SUBDIRS = (os.path.join(".hermes", "skills"), os.path.join(".agents", "skills"))  # haos-legacy-path: project-relative: .hermes/skills DENTRO do projeto, nao o home
