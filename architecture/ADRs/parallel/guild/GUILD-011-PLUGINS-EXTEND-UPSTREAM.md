# GUILD-011: Plugins Extend Upstream, Not Replace It

> **Series:** Guild — parallel, non-canonical. Canonical ID: `GUILD-011` (renamed from `ADR-011`). Canonical counterpart: `GOV-012`. Registry: [`INDEX.md`](../../INDEX.md).
