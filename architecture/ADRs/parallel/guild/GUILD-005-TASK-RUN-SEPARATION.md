# GUILD-005: Task ≠ Run (Separation of Goal and Execution Attempt)

> **Series:** Guild — parallel, non-canonical. Canonical ID: `GUILD-005` (renamed from `ADR-005`). Canonical counterpart: `GOV-003`. Registry: [`INDEX.md`](../../INDEX.md).
