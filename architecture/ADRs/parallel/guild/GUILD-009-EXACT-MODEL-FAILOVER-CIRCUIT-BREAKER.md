# GUILD-009: Exact-Model Provider Failover & Circuit Breakers

> **Series:** Guild — parallel, non-canonical. Canonical ID: `GUILD-009` (renamed from `ADR-009`). Canonical counterpart: `GOV-005`. Registry: [`INDEX.md`](../../INDEX.md).
