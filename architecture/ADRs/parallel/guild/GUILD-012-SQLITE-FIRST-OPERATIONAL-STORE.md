# GUILD-012: SQLite-First Operational Store (WAL Mode)

> **Series:** Guild — parallel, non-canonical. Canonical ID: `GUILD-012` (renamed from `ADR-012`). Canonical counterpart: `GOV-011`. Registry: [`INDEX.md`](../../INDEX.md).
