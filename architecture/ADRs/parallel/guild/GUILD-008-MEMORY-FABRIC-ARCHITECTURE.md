# GUILD-008: Memory Fabric Architecture (Obsidian & GraphRAG)

> **Series:** Guild — parallel, non-canonical. Canonical ID: `GUILD-008` (renamed from `ADR-008`). Canonical counterpart: `GOV-008`. Registry: [`INDEX.md`](../../INDEX.md).
