# GUILD-001: Hermes Remains Kernel

> **Series:** Guild — parallel, non-canonical. Canonical ID: `GUILD-001` (renamed from `ADR-001`). Canonical counterpart: `GOV-001`. Registry: [`INDEX.md`](../../INDEX.md).
