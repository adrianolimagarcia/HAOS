# GUILD-010: Worker Lane Execution Model (GenericWorkerLane)

> **Series:** Guild — parallel, non-canonical. Canonical ID: `GUILD-010` (renamed from `ADR-010`). Canonical counterpart: `GOV-010`. Registry: [`INDEX.md`](../../INDEX.md).
