# GUILD-006: Artifact-Driven Agent Communication

> **Series:** Guild — parallel, non-canonical. Canonical ID: `GUILD-006` (renamed from `ADR-006`). Canonical counterpart: `GOV-009`. Registry: [`INDEX.md`](../../INDEX.md).
