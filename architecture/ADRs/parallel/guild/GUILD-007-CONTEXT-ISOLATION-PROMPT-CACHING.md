# GUILD-007: Context Isolation & Byte-Stable Prompt Caching

> **Series:** Guild — parallel, non-canonical. Canonical ID: `GUILD-007` (renamed from `ADR-007`). Canonical counterpart: `GOV-007`. Registry: [`INDEX.md`](../../INDEX.md).
