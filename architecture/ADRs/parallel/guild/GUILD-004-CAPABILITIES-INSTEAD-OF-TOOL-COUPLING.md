# GUILD-004: Capabilities Instead of Tool Coupling

> **Series:** Guild — parallel, non-canonical. Canonical ID: `GUILD-004` (renamed from `ADR-004`). Canonical counterpart: `GOV-006`. Registry: [`INDEX.md`](../../INDEX.md).
