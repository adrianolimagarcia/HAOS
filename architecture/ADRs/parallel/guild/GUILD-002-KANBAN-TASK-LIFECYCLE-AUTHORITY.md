# GUILD-002: Kanban Remains Task Lifecycle Authority

> **Series:** Guild — parallel, non-canonical. Canonical ID: `GUILD-002` (renamed from `ADR-002`). Canonical counterpart: `GOV-002`. Registry: [`INDEX.md`](../../INDEX.md).
