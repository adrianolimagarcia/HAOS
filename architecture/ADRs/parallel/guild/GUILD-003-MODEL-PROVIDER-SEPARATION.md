# GUILD-003: Model / Provider Separation Axiom

> **Series:** Guild — parallel, non-canonical. Canonical ID: `GUILD-003` (renamed from `ADR-003`). Canonical counterpart: `GOV-004`. Registry: [`INDEX.md`](../../INDEX.md).
