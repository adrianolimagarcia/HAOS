# ADR-017: Scheduled Routine Contracts & Boundary Approvals

- **Status:** Approved
- **Date:** 2026-09-09
- **Governed By:** ADR-001 (Hermes Remains Kernel), ADR-002 (Task Lifecycle), ADR-012 (SQLite-First), ADR-016 (Anti-Drift Topologies)
