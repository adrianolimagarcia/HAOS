# ADR-018: Ultrawork (ulw) Outcome-First & Evidence-Driven Execution

- **Status:** Approved
- **Date:** 2026-09-09
- **Governed By:** ADR-001 (Hermes Remains Kernel), ADR-002 (Task Lifecycle), ADR-010 (Worker Lanes), ADR-016 (Anti-Drift Topologies)
