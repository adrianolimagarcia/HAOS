...
export const defaultTheme: DashboardTheme = {
  ...
  description: "HAOS light liquid glass — milky panels, system-blue pill, Inspector chrome",
  palette: {
    background: { hex: "#eef3fb", alpha: 1 },
    midground: { hex: "#1c1c1e", alpha: 1 },
    foreground: { hex: "#ffffff", alpha: 0 },
    warmGlow: "rgba(10, 132, 255, 0.18)",
    noiseOpacity: 0.2,
  },
  typography: {
    ...DEFAULT_TYPOGRAPHY,
  ...
  terminalBackground: "#f7f9fd",
  terminalForeground: "#1c1c1e",
  swatchColors: ["#eef3fb", "#0a84ff", "#1c1c1e"],
  seriesColors: {
    inputTokenAccent: "#5ac8fa",
    outputTokenAccent: "#0a84ff",
  },
  colorOverrides: {
    primary: "#0a84ff",
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Liquid Glass Light (Large)",
  description: "Same HAOS liquid glass light theme with bigger type and spacing",
