...
from hermes_constants import OPENROUTER_BASE_URL, get_hermes_home, product_command
...
class TrajectoryCompressor:
    ...
    def _init_summarizer(self):
        ...
        if provider:
            ...
            if client is None:
                raise RuntimeError(f"Provider '{provider}' is not configured. Check your API key or run: {product_command('setup')}")
